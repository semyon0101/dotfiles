return {
    ...
    config = function()
            ...
            options = {
                ...
                offsets = {
                    ...
                    },
                    {
                        ...
                        text_align = "center",
                        separator = true,
                        highlight = "ToggleTermTabHighlight",
                    },
                },
                color_icons = true,
        ...
        -- Initial base colors (inactive state)
        vim.api.nvim_set_hl(0, "NvimTreeTabHighlight", { bg = "#1a1b26", fg = "#787c99", bold = false })
        vim.api.nvim_set_hl(0, "ToggleTermTabHighlight", { bg = "#1a1b26", fg = "#787c99", bold = false })

        -- Update tab highlights on focus change
        vim.api.nvim_create_autocmd({ "WinEnter", "WinLeave", "BufEnter", "FileType" }, {
            callback = function()
                vim.schedule(function()
                    ...
                    -- ToggleTerm active state
                    if ft == "toggleterm" then
                        vim.api.nvim_set_hl(0, "ToggleTermTabHighlight", { bg = "#3b4261", fg = "#7aa2f7", bold = true })
                    else
                        vim.api.nvim_set_hl(0, "ToggleTermTabHighlight", { bg = "#1a1b26", fg = "#787c99", bold = false })
                    end
                end)
